...
docker run --rm -it -p 9020:8080 -p 9021:5900 ctf-kali
```

## Notes
For windows systems the end of file sequence must be 'LF' to run the container with the entrypoint.sh script
